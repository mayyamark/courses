// Testing Components With State And Effects (with React Testing Library) - Mocking The useEffect Hook & Async Testing
...
describe("RandomImage", () => {
  describe("with mocking", () => {
    it("should render an image with the random url", async () => {
      randomImageService.getRandomImageUrl.mockResolvedValue(
