// Testing Components With State Management (with React Testing Library) - Testing Redux & Testing Events & Async Testing
...
describe("App", () => {
  ...
  describe("selecting a pre-curiosity day and changing criteria", () => {
    it("should show the correct number of images", async () => {
      ...
      fireEvent.change(cameraSelect, { target: { value: "NAVCAM" } });
      await wait(() => {
        const images = renderResult.getAllByTestId("rover-image");
